...
function M.action(selected_option)
  ...
  local entry_point = utils.os_path(current_file)
  local files = utils.find_files_to_compile(entry_point, file_name, true) -- *.c files under entry_point_dir (recursively)
  ...
  local arguments = "-std=c++11 -O2 -Wall -g"
  ...
  elseif selected_option == "option4" then
    ...
    if solution_file then
      ...
      for entry, variables in pairs(config) do
        ...
        files = utils.find_files_to_compile(entry_point, "*.cxx")
      ...
      entry_points = utils.find_files(vim.fn.getcwd(), "main.cxx")
